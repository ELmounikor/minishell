...
/*   Updated: 2022/09/26 21:57:35 by mel-kora         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av, char **en)
{
	...
	while (1)
	{
		...
		if (input)
		{
			...
			param_extractor(&params, env, input);
			// env_extractor(&params, NULL, NULL); //env to be updated in between child processes using
